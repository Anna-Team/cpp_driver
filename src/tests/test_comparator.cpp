...
TEST(annadb_query_find, find_eq_field)
{
    ...
    }
    {
        ...
        auto eq_root = annadb::Query::Eq("path.to.nested.field",
                                         tyson::TySonObject::String("foo"));
...
TEST(annadb_query_find, find_and_field)
{
    ...
    }
    {
        ...
        auto and_val = annadb::Query::And(eq_root, neq_field);
...
TEST(annadb_query_find, find_or_field)
{
    ...
    }
    {
        ...
        auto and_val = annadb::Query::Or(eq_root, neq_field);
